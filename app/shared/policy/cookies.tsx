...
export default function Cookies() {
  return (
    <View className='gap-[24px]'>
      <Text className='text-[32px] text-white'>Cookie Policy</Text>
      ...
      <Text className='text-[18px] text-white'>This Cookie Policy should be read in conjunction with our Privacy Policy. If you have any questions or concerns about the Cookie Policy or its implementation, please contact us at info@bffl.ai, or as otherwise described in our Privacy Policy.</Text>

      <Text className='text-[28px] text-white'>1. What are cookies and similar technologies?</Text>
      ...
      <Text className='text-[18px] text-white'>This Cookie Policy refers to all these technologies collectively as “cookies.”</Text>

      <Text className='text-[28px] text-white'>2. What type of information do cookies collect?</Text>
      ...
      <Text className='text-[28px] text-white'>3. Why do we use cookies?</Text>
      ...
      <Text className='text-[28px] text-white'>4. How can you control cookies?</Text>
      ...
      <Text className='text-[28px] text-white'>5. How often will we update this Cookie Policy?</Text>
      ...
      <Text className='text-[18px] text-white'>The date at the top of this Cookie Policy indicates when it was last updated.</Text>

      <Text className='text-[28px] text-white'>6. Where can you get further information?</Text>

      <Text className='text-[18px] text-white'>If you have any questions about our use of cookies or other technologies, please email us at info@bffl.ai.</Text>
    </View>
  )
}
