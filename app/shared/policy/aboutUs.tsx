...
export default function AboutUs() {
  return (
    <View className='gap-[24px]'>
      <Text className='text-[32px] text-white'>About us</Text>
      ...
      <Text className='text-[18px] text-white'>BFFL.AI is based in the U.S.A and registered as an LLC in Dover, DE © Copyright 2024 BFFL.AI, LLC</Text>
    </View>
  )
}
